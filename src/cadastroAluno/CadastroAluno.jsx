...
import Form from './cadastroAlunoForm'
import { create, update, remove, submitSearch } from './cadastroAlunoActions'
...
class CadastroAluno extends Component {
    ...
    render() {
        return (
            <div>
                <ContentHeader title='Alunos' small='cadastro' />
                <Content>
                    <Tabs>
                        <TabsHeader>
...
const mapDispatchToProps = dispatch => bindActionCreators({ selectTab, showTabs, create, update, remove, submitSearch }, dispatch)
