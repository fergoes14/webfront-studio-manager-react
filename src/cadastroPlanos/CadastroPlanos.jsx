...
import List from './CadastroPlanosList'


import Form from './CadastroPlanosForm'
import { create, update, remove } from './CadastroPlanosAction'

class CadastroPlanos extends Component {
    ...
    render() {
        return (
            <div>
                <ContentHeader title='Planos' small='cadastro' />
                <Content>
                    <Tabs>
                        <TabsHeader>
...
export default connect(null, mapDispatchToProps)(CadastroPlanos)
