...
import List from './CadastroSalasList'


import Form from './CadastroSalasForm'
import { create, update, remove } from './CadastroSalasAction'
...
class  cadastroSalas extends Component {
    ...
    render() {
        return (
            <div>
                <ContentHeader title='Salas' small='cadastro' />
                <Content>
                    <Tabs>
                        <TabsHeader>
...
export default connect(null, mapDispatchToProps)(cadastroSalas)
